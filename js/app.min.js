...
function initializeMap() {
    var e = document.getElementById("gmap"),
        t = new google.maps.LatLng(20.9595693, 105.7678605),
        n = {
            scrollwheel: !1,
            draggable: !1,
            center: t,
        ...
        i = new google.maps.Map(e, n),
        o = new google.maps.Marker({
            position: t,
            map: i
        }),
        s = new google.maps.InfoWindow({
            content: "<b>vCube Game</b><br/>Van Phu - Ha Dong<br/>Hanoi"
        });
    ...
    function u(e, t, n, i) {
        var o, s = 1,
            ...
            c = (se.cssNumber[t] || "px" !== u && +l) && Oe.exec(se.css(e, t));
        if (c && c[3] !== u) {
            u = u || c[3], n = n || [], c = +l || 1;
    ...
    function h(e, t, n, i, o) {
        for (var s, r, a, l, u, h, f = t.createDocumentFragment(), p = [], g = 0, m = e.length; g < m; g++)
            if (s = e[g], s || 0 === s)
                if ("object" === se.type(s)) se.merge(p, s.nodeType ? [s] : s);
                else if (He.test(s)) {
            for (r = r || f.appendChild(t.createElement("div")), a = (Pe.exec(s) || ["", ""])[1].toLowerCase(), l = qe[a] || qe._default, r.innerHTML = l[1] + se.htmlPrefilter(s) + l[2], h = l[0]; h--;) r = r.lastChild;
        ...
        for (f.textContent = "", g = 0; s = p[g++];)
            ...
            for (h = 0; s = r[h++];) Re.test(s.type || "") && n.push(s);
        return f
    }
    ...
    function $(e, t, n, i) {
        ...
        var o, s, r, a, l, u, d = 0,
            ...
            g = t[0],
            m = se.isFunction(g);
        if (m || f > 1 && "string" == typeof g && !ie.checkClone && Be.test(g)) return e.each(function(o) {
            var s = e.eq(o);
            m && (t[0] = g.call(this, o, s.html())), $(s, t, n, i)
        });
    ...
    function O(e, t, n, i, o) {
        for (var s = n === (i ? "border" : "content") ? 4 : "width" === t ? 1 : 0, r = 0; s < 4; s += 2) "margin" === n && (r += se.css(e, n + Ae[s], !0, o)), i ? ("content" === n && (r -= se.css(e, "padding" + Ae[s], !0, o)), "margin" !== n && (r -= se.css(e, "border" + Ae[s] + "Width", !0, o))) : (r += se.css(e, "padding" + Ae[s], !0, o), "padding" !== n && (r += se.css(e, "border" + Ae[s] + "Width", !0, o)));
        return r
    }
    ...
    function A(e, t, n) {
        ...
        return o + O(e, t, n || (r ? "border" : "content"), i, s) + "px"
    }
    ...
    function H(e, t, n) {
        ...
        })), 1 === e.nodeType && ("height" in t || "width" in t) && (n.overflow = [f.overflow, f.overflowX, f.overflowY], u = se.css(e, "display"), c = "none" === u ? _e.get(e, "olddisplay") || _(e.nodeName) : u, "inline" === c && "none" === se.css(e, "float") && (f.display = "inline-block")), n.overflow && (f.overflow = "hidden", d.always(function() {
        ...
        if (se.isEmptyObject(h)) "inline" === ("none" === u ? _(e.nodeName) : u) && (f.display = u);
            ...
            g ? "hidden" in g && (p = g.hidden) : g = _e.access(e, "fxshow", {}), s && (g.hidden = !p), p ? se(e).show() : d.done(function() {
                se(e).hide()
            }), d.done(function() {
                var t;
                _e.remove(e, "fxshow");
            ...
            for (i in h) r = q(p ? g[i] : 0, i, d), i in g || (g[i] = r.start, p && (r.end = r.start, r.start = "width" === i || "height" === i ? 1 : 0))
        }
    }
    ...
    function K(e, t, n, i) {
        ...
        if (se.isArray(t)) se.each(t, function(t, o) {
            n || Ot.test(e) ? i(e, o) : K(e + "[" + ("object" == typeof o && null != o ? t : "") + "]", o, n, i)
        });
    ...
    se.fn = se.prototype = {
        ...
        proxy: function(e, t) {
            var n, i, o;
            if ("string" == typeof t && (n = e[t], t = e, e = n), se.isFunction(e)) return i = X.call(arguments, 2), o = function() {
    ...
    var ce = function(e) {
        function t(e, t, n, i) {
            ...
            if (!i && ((t ? t.ownerDocument || t : L) !== S && A(t), t = t || S, P)) {
                if (11 !== g && (u = ve.exec(e)))
                    if (o = u[1]) {
                        if (9 === g) {
                ...
                if (C.qsa && !Q[e + " "] && (!R || !R.test(e))) {
                    if (1 !== g) p = t, f = e;
                        ...
                        for ((a = t.getAttribute("id")) ? a = a.replace(be, "\\$&") : t.setAttribute("id", a = N), d = _(e), s = d.length, l = he.test(a) ? "#" + a : "[id='" + a + "']"; s--;) d[s] = l + " " + h(d[s]);
        ...
        function f(e, t, n) {
            ...
            return t.first ? function(t, n, s) {
                ...
                if (r) {
                    ...
                    for (; t = t[i];)
                        if (1 === t.nodeType || o) {
                            if (u = t[N] || (t[N] = {}), l = u[t.uniqueID] || (u[t.uniqueID] = {}), (a = l[i]) && a[0] === M && a[1] === s) return c[2] = a[2];
        ...
        function v(e, t, n, o, s, r) {
            return o && !o[N] && (o = v(o)), s && !s[N] && (s = v(s, r)), i(function(i, r, a, l) {
                ...
                } else b = m(b === r ? b.splice(p, b.length) : b), s ? s(null, r, b, l) : V.apply(r, b)
            })
        }

        function y(e) {
            for (var t, n, i, o = e.length, s = $.relative[e[0].type], r = s || $.relative[" "], a = s ? 1 : 0, l = f(function(e) {
                    return e === t
                }, r, !0), u = f(function(e) {
                    return ee(t, e) > -1
                ...
                if (n = $.relative[e[a].type]) c = [f(p(c), n)];
                else {
            ...
            var o = n.length > 0,
                ...
                r = function(i, r, a, l, u) {
                    ...
                    for (u && (z = r === S || r || u); p !== C && null != (c = b[p]); p++) {
                        if (s && c) {
                            for (d = 0, r || c.ownerDocument === S || (A(c), a = !P); h = e[d++];)
                                if (h(c, r || S, a)) {
                                    l.push(c);
                                    break
                                }
        ...
        var w, C, $, x, k, _, F, T, z, E, O, A, S, D, P, R, q, H, j, N = "sizzle" + 1 * new Date,
            L = e.document,
            M = 0,
            I = 0,
            B = n(),
        ...
        try {
            V.apply(G = J.call(L.childNodes), L.childNodes), G[L.childNodes.length].nodeType
        } catch (xe) {
            V = {
        ...
        C = t.support = {}, k = t.isXML = function(e) {
            ...
            return i !== S && 9 === i.nodeType && i.documentElement ? (S = i, D = S.documentElement, P = !k(S), (n = S.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", $e, !1) : n.attachEvent && n.attachEvent("onunload", $e)), C.attributes = o(function(e) {
                return e.className = "i", !e.getAttribute("className")
            }), C.getElementsByTagName = o(function(e) {
                return e.appendChild(S.createComment("")), !e.getElementsByTagName("*").length
            }), C.getElementsByClassName = me.test(S.getElementsByClassName), C.getById = o(function(e) {
            ...
            }, q = [], R = [], (C.qsa = me.test(S.querySelectorAll)) && (o(function(e) {
            ...
            })), (C.matchesSelector = me.test(H = D.matches || D.webkitMatchesSelector || D.mozMatchesSelector || D.oMatchesSelector || D.msMatchesSelector)) && o(function(e) {
                C.disconnectedMatch = H.call(e, "div"), H.call(e, "[s!='']:x"), q.push("!=", se)
            }), R = R.length && new RegExp(R.join("|")), q = q.length && new RegExp(q.join("|")), t = me.test(D.compareDocumentPosition), j = t || me.test(D.contains) ? function(e, t) {
                ...
                return n ? n : (n = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1, 1 & n || !C.sortDetached && t.compareDocumentPosition(e) === n ? e === S || e.ownerDocument === L && j(L, e) ? -1 : t === S || t.ownerDocument === L && j(L, t) ? 1 : E ? ee(E, e) - ee(E, t) : 0 : 4 & n ? -1 : 1)
            } : function(e, t) {
                if (e === t) return O = !0, 0;
                var n, i = 0,
                    o = e.parentNode,
                ...
                for (; a[i] === l[i];) i++;
                return i ? r(a[i], l[i]) : a[i] === L ? -1 : l[i] === L ? 1 : 0
            }, S) : S
        }, t.matches = function(e, n) {
            return t(e, null, null, n)
        }, t.matchesSelector = function(e, n) {
            if ((e.ownerDocument || e) !== S && A(e), n = n.replace(ce, "='$1']"), C.matchesSelector && P && !Q[n + " "] && (!q || !q.test(n)) && (!R || !R.test(n))) try {
                var i = H.call(e, n);
                if (i || C.disconnectedMatch || e.document && 11 !== e.document.nodeType) return i
            } catch (o) {}
            return t(n, S, null, [e]).length > 0
        }, t.contains = function(e, t) {
            return (e.ownerDocument || e) !== S && A(e), j(e, t)
        }, t.attr = function(e, t) {
            (e.ownerDocument || e) !== S && A(e);
            var n = $.attrHandle[t.toLowerCase()],
                i = n && U.call($.attrHandle, t.toLowerCase()) ? n(e, t, !P) : void 0;
            ...
            var t, n = [],
                i = 0,
                o = 0;
            if (O = !C.detectDuplicates, E = !C.sortStable && e.slice(0), e.sort(K), O) {
            ...
            filter: {
                ...
                CHILD: function(e, t, n, i, o) {
                    ...
                    return 1 === i && 0 === o ? function(e) {
                        ...
                        var u, c, d, h, f, p, g = s !== r ? "nextSibling" : "previousSibling",
                            m = t.parentNode,
                        ...
                        if (m) {
                            ...
                            if (p = [r ? m.firstChild : m.lastChild], r && y) {
                                for (h = m, d = h[N] || (h[N] = {}), c = d[h.uniqueID] || (d[h.uniqueID] = {}), u = c[e] || [], f = u[0] === M && u[1], b = f && u[2], h = f && m.childNodes[f]; h = ++f && h && h[g] || (b = f = 0) || p.pop();)
                                    if (1 === h.nodeType && ++b && h === t) {
                                        c[e] = [M, f, b];
                                        break
                                    }
                            } else if (y && (h = t, d = h[N] || (h[N] = {}), c = d[h.uniqueID] || (d[h.uniqueID] = {}), u = c[e] || [], f = u[0] === M && u[1], b = f), b === !1)
                                for (;
                                    (h = ++f && h && h[g] || (b = f = 0) || p.pop()) && ((a ? h.nodeName.toLowerCase() !== v : 1 !== h.nodeType) || !++b || (y && (d = h[N] || (h[N] = {}), c = d[h.uniqueID] || (d[h.uniqueID] = {}), c[e] = [M, b]), h !== t)););
                ...
                PSEUDO: function(e, n) {
                    ...
                    return s[N] ? s(n) : s.length > 1 ? (o = [e, e, "", n], $.setFilters.hasOwnProperty(e.toLowerCase()) ? i(function(e, t) {
        ...
        return d.prototype = $.filters = $.pseudos, $.setFilters = new d, _ = t.tokenize = function(e, n) {
            ...
            for (a = e, l = [], u = $.preFilter; a;) {
                ...
                for (r in $.filter) !(o = fe[r].exec(a)) || u[r] && !(o = u[r](o)) || (i = o.shift(), s.push({
                    value: i,
                    type: r,
                    matches: o
                }), a = a.slice(i.length));
            ...
            if (n = n || [], 1 === d.length) {
                ...
                for (o = fe.needsContext.test(e) ? 0 : s.length; o-- && (r = s[o], !$.relative[a = r.type]);)
        ...
        }, C.sortStable = N.split("").sort(K).join("") === N, C.detectDuplicates = !!O, A(), C.sortDetached = o(function(e) {
    ...
    se.fn.ready = function(e) {
        ...
        ready: function(e) {
            (e === !0 ? --se.readyWait : se.isReady) || (se.isReady = !0, e !== !0 && --se.readyWait > 0 || ($e.resolveWith(G, [se]), se.fn.triggerHandler && (se(G).triggerHandler("ready"), se(G).off("ready"))))
        }
    }), se.ready.promise = function(t) {
        return $e || ($e = se.Deferred(), "complete" === G.readyState || "loading" !== G.readyState && !G.documentElement.doScroll ? e.setTimeout(se.ready) : (G.addEventListener("DOMContentLoaded", r), e.addEventListener("load", r))), $e.promise(t)
    }, se.ready.promise();
    ...
    se.extend({
        ...
        data: function(e, t) {
            var n, i, o, s = this[0],
                r = s && s.attributes;
            if (void 0 === e) {
                if (this.length && (o = Fe.get(s), 1 === s.nodeType && !_e.get(s, "hasDataAttrs"))) {
                    for (n = r.length; n--;) r[n] && (i = r[n].name, 0 === i.indexOf("data-") && (i = se.camelCase(i.slice(5)), l(s, i, o[i])));
                    _e.set(s, "hasDataAttrs", !0)
                }
                return o
            }
            return "object" == typeof e ? this.each(function() {
                ...
                var n, i;
                if (s && void 0 === t) {
                    if (n = Fe.get(s, e) || Fe.get(s, e.replace(ze, "-$&").toLowerCase()), void 0 !== n) return n;
                    if (i = se.camelCase(e), n = Fe.get(s, i), void 0 !== n) return n;
    ...
    se.event = {
        ...
        add: function(e, t, n, i, o) {
            var s, r, a, l, u, c, d, h, f, p, g, m = _e.get(e);
            if (m)
                for (n.handler && (s = n, n = s.handler, o = s.selector), n.guid || (n.guid = se.guid++), (l = m.events) || (l = m.events = {}), (r = m.handle) || (r = m.handle = function(t) {
                        return "undefined" != typeof se && se.event.triggered !== t.type ? se.event.dispatch.apply(e, arguments) : void 0
                    }), t = (t || "").match(Ce) || [""], u = t.length; u--;) a = Le.exec(t[u]) || [], f = g = a[1], p = (a[2] || "").split(".").sort(), f && (d = se.event.special[f] || {}, f = (o ? d.delegateType : d.bindType) || f, d = se.event.special[f] || {}, c = se.extend({
                    type: f,
                    origType: g,
                    data: i,
                    handler: n,
        ...
        remove: function(e, t, n, i, o) {
            var s, r, a, l, u, c, d, h, f, p, g, m = _e.hasData(e) && _e.get(e);
            if (m && (l = m.events)) {
                for (t = (t || "").match(Ce) || [""], u = t.length; u--;)
                    if (a = Le.exec(t[u]) || [], f = g = a[1], p = (a[2] || "").split(".").sort(), f) {
                        for (d = se.event.special[f] || {}, f = (i ? d.delegateType : d.bindType) || f, h = l[f] || [], a = a[2] && new RegExp("(^|\\.)" + p.join("\\.(?:.*\\.|)") + "(\\.|$)"), r = s = h.length; s--;) c = h[s], !o && g !== c.origType || n && n.guid !== c.guid || a && !a.test(c.namespace) || i && i !== c.selector && ("**" !== i || !c.selector) || (h.splice(s, 1), c.selector && h.delegateCount--, d.remove && d.remove.call(e, c));
                        r && !h.length && (d.teardown && d.teardown.call(e, p, m.handle) !== !1 || se.removeEvent(e, f, m.handle), delete l[f])
                    } else
    ...
    se.extend({
        ...
        clone: function(e, t, n) {
            ...
            if (!(ie.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || se.isXMLDoc(e)))
                for (r = c(a), s = c(e), i = 0, o = s.length; i < o; i++) C(s[i], r[i]);
            if (t)
                if (n)
    ...
    se.extend({
        ...
        se.cssHooks[t] = {
            ...
            set: function(e, n, i) {
                var o, s = i && Xe(e),
                    r = i && O(e, t, i, "border-box" === se.css(e, "boxSizing", !1, s), s);
                return r && (o = Oe.exec(n)) && "px" !== (o[3] || "px") && (e.style[t] = n, n = se.css(e, t)), E(e, n, r)
            }
        }
    ...
    se.fn.extend({
        addClass: function(e) {
            ...
            if (se.isFunction(e)) return this.each(function(t) {
                se(this).addClass(e.call(this, t, L(this)))
            });
            if ("string" == typeof e && e)
                for (t = e.match(Ce) || []; n = this[l++];)
                    if (o = L(n), i = 1 === n.nodeType && (" " + o + " ").replace(ht, " ")) {
        ...
        removeClass: function(e) {
            var t, n, i, o, s, r, a, l = 0;
            if (se.isFunction(e)) return this.each(function(t) {
                se(this).removeClass(e.call(this, t, L(this)))
            });
        ...
        toggleClass: function(e, t) {
            ...
            return "boolean" == typeof t && "string" === n ? t ? this.addClass(e) : this.removeClass(e) : se.isFunction(e) ? this.each(function(n) {
                se(this).toggleClass(e.call(this, n, L(this), t), t)
            }) : this.each(function() {
                var t, i, o, s;
                if ("string" === n)
                    for (i = 0, o = se(this), s = e.match(Ce) || []; t = s[i++];) o.hasClass(t) ? o.removeClass(t) : o.addClass(t);
                else void 0 !== e && "boolean" !== n || (t = L(this), t && _e.set(this, "__className__", t), this.setAttribute && this.setAttribute("class", t || e === !1 ? "" : _e.get(this, "__className__") || ""))
            })
        },
        hasClass: function(e) {
            var t, n, i = 0;
    ...
    se.extend(se.event, {
        trigger: function(t, n, i, o) {
            var s, r, a, l, u, c, d, h = [i || G],
                f = ne.call(t, "type") ? t.type : t,
                p = ne.call(t, "namespace") ? t.namespace.split(".") : [];
            if (r = a = i = i || G, 3 !== i.nodeType && 8 !== i.nodeType && !gt.test(f + se.event.triggered) && (f.indexOf(".") > -1 && (p = f.split("."), f = p.shift(), p.sort()), u = f.indexOf(":") < 0 && "on" + f, t = t[se.expando] ? t : new se.Event(f, "object" == typeof t && t), t.isTrigger = o ? 2 : 3, t.namespace = p.join("."), t.rnamespace = t.namespace ? new RegExp("(^|\\.)" + p.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = i), n = null == n ? [t] : se.makeArray(n, [t]), d = se.event.special[f] || {}, o || !d.trigger || d.trigger.apply(i, n) !== !1)) {
                if (!o && !d.noBubble && !se.isWindow(i)) {
                    for (l = d.delegateType || f, gt.test(l + f) || (r = r.parentNode); r; r = r.parentNode) h.push(r), a = r;
                    a === (i.ownerDocument || G) && h.push(a.defaultView || a.parentWindow || e)
                }
                for (s = 0;
                    (r = h[s++]) && !t.isPropagationStopped();) t.type = s > 1 ? l : d.bindType || f, c = (_e.get(r, "events") || {})[t.type] && _e.get(r, "handle"), c && c.apply(r, n), c = u && r[u], c && c.apply && ke(r) && (t.result = c.apply(r, n), t.result === !1 && t.preventDefault());
                return t.type = f, o || t.isDefaultPrevented() || d._default && d._default.apply(h.pop(), n) !== !1 || !ke(i) || u && se.isFunction(i[f]) && !se.isWindow(i) && (a = i[u], a && (i[u] = null), se.event.triggered = f, i[f](), se.event.triggered = void 0, a && (i[u] = a)), t.result
            }
        },
    ...
    zt.href = mt.href, se.extend({
        ...
        ajax: function(t, n) {
            ...
            if (g.promise($).complete = m.add, $.success = $.done, $.error = $.fail, h.url = ((t || h.url || mt.href) + "").replace(bt, "").replace(kt, mt.protocol + "//"), h.type = n.method || n.type || h.method || h.type, h.dataTypes = se.trim(h.dataType || "*").toLowerCase().match(Ce) || [""], null == h.crossDomain) {
                u = G.createElement("a");
                try {
            ...
            if (o = I(Ft, h, n, $)) {
                if ($.readyState = 1, c && p.trigger("ajaxSend", [$, h]), 2 === w) return $;
    ...
    return se.noConflict = function(t) {
        return e.$ === se && (e.$ = Lt), t && e.jQuery === se && (e.jQuery = Nt), se
    }, t || (e.jQuery = e.$ = se), se
}), window.whatInput = function() {
        "use strict";

        function e() {
            i(), o(event), g = !0, C = window.setTimeout(function() {
                g = !1
            }, 650)
        }
        ...
        function o(e) {
            var t = r(e),
                n = w[e.type];
            if ("pointer" === n && (n = l(e)), m !== n) {
                var i = a(e),
                    o = i.nodeName.toLowerCase(),
                    c = "input" === o ? i.getAttribute("type") : null;
                !f.hasAttribute("data-whatinput-formtyping") && m && "keyboard" === n && "tab" !== x[t] && ("textarea" === o || "select" === o || "input" === o && v.indexOf(c) < 0) || b.indexOf(t) > -1 || s(n)
            }
            "keyboard" === n && u(t)
        }

        function s(e) {
            m = e, f.setAttribute("data-whatinput", m), $.indexOf(m) === -1 && $.push(m)
        }
        ...
        function u(e) {
            p.indexOf(x[e]) === -1 && x[e] && p.push(x[e])
        }
        ...
        function d() {
            f = document.body, window.PointerEvent ? (f.addEventListener("pointerdown", t), f.addEventListener("pointermove", t)) : window.MSPointerEvent ? (f.addEventListener("MSPointerDown", t), f.addEventListener("MSPointerMove", t)) : (f.addEventListener("mousedown", t), f.addEventListener("mousemove", t), "ontouchstart" in window && f.addEventListener("touchstart", e)), f.addEventListener(y, t), f.addEventListener("keydown", n), f.addEventListener("keyup", n), document.addEventListener("keyup", c)
        }
...
! function(e) {
    var t = function() {
        ...
        return _createClass(t, [{
            ...
            key: "destroy",
            value: function() {
                this._hideAll(), Foundation.Nest.Burn(this.$element, "drilldown"), this.$element.unwrap().find(".js-drilldown-back, .is-submenu-parent-item").remove().end().find(".is-active, .is-closing, .is-drilldown-submenu").removeClass("is-active is-closing is-drilldown-submenu").end().find("[data-submenu]").removeAttr("aria-hidden tabindex role"),
                    this.$submenuAnchors.each(function() {
            ...
            value: function(e, n, i, o) {
                if (!this.$element.hasClass(this.options.disabledClass)) {
                    ...
                    var l = this,
                        ...
                        g = (f - h) * p,
                        m = (100 * t(g, f)).toFixed(this.options.decimal);
                    n = parseFloat(n.toFixed(this.options.decimal));
                    var v = {};
                    if (this._setValues(e, n), s) {
                        var y, b = 0 === this.handles.index(e),
                            w = ~~(100 * t(h, f));
                        if (b) v[d] = m + "%", y = parseFloat(this.$handle2[0].style[d]) - m + w, o && "function" == typeof o && o();
                        else {
                            var C = parseFloat(this.$handle[0].style[d]);
                            y = m - (isNaN(C) ? this.options.initialStart / ((this.options.end - this.options.start) / 100) : C) + w
                        }
                        v["min-" + c] = y + "%"
                    }
                    ...
                    Foundation.Move($, e, function() {
                        e.css(d, m + "%"), l.options.doubleSided ? l.$fill.css(v) : l.$fill.css(c, 100 * p + "%")
            ...
            value: function(i, o, s) {
                ...
                if (s) r = this._adjustValue(null, s), a = !0;
                    ...
                    if (r = (this.options.end - this.options.start) * y + this.options.start, Foundation.rtl() && !this.options.vertical && (r = this.options.end - r), r = l._adjustValue(null, r), a = !1, !o) {
                        var b = n(this.$handle, d, m, c),
                            w = n(this.$handle2, d, m, c);
...
! function(e) {
    ...
    function t(e) {
        var t, n, i, o, s, r, a, l = {};
        for (s = e.replace(/\s*:\s*/g, ":").replace(/\s*,\s*/g, ",").split(","), a = 0, r = s.length; a < r && (n = s[a], n.search(/^(http|https|ftp):\/\//) === -1 && n.search(":") !== -1); a++) t = n.indexOf(":"), i = n.substring(0, t), o = n.substring(t + 1), o || (o = void 0), "string" == typeof o && (o = "true" === o || "false" !== o && o), "string" == typeof o && (o = isNaN(o) ? o : +o), l[i] = o;
    ...
    function n(e) {
        ...
        var t, n, i, o = e.split(/\s+/),
            s = "50%",
            r = "50%";
        for (i = 0, t = o.length; i < t; i++) n = o[i], "left" === n ? s = "0%" : "right" === n ? s = "100%" : "top" === n ? r = "0%" : "bottom" === n ? r = "100%" : "center" === n ? 0 === i ? s = "50%" : r = "50%" : 0 === i ? s = n : r = n;
        return {
            x: s,
            y: r
        }
    ...
    function o(n, i, o) {
        ...
        this.settings = e.extend({}, r, o), this.path = i;
        try {
            this.init()
        } catch (l) {
    ...
    o.prototype.init = function() {
        var t, o, s = this,
            ...
            h = n(d.position),
            f = d.posterType;
        o = s.$wrapper = e("<div>").addClass(d.className).css({
            position: "absolute",
            "z-index": -1,
            top: 0,
            left: 0,
        ...
        }), "object" == typeof r && (r.poster ? l = r.poster : r.mp4 ? l = r.mp4 : r.webm ? l = r.webm : r.ogv && (l = r.ogv)), "detect" === f ? i(l, function(e) {
        ...
        var i;
        return this.each(function() {
            i = e.data(this, s), i && i.destroy(), i = new o(this, t, n), i.index = e[s].lookup.push(i) - 1, e.data(this, s, i)
        }), this
    }, e(document).ready(function() {
        var t = e(window);
        t.on("resize.vide", function() {
            for (var t, n = e[s].lookup.length, i = 0; i < n; i++) t = e[s].lookup[i], t && t.settings.resizing && t.resize()
...
function(e) {
    ...
    function t(n) {
        this.$el = e(n), this.index = 0, this.config = e.extend({}, t.defaultConfig), this._setupBackgroundElement(), this._listenToResize()
    }
    var n = {},
        i = Array.prototype.slice,
        o = Object.prototype.toString,
        s = ["Top", "Right", "Bottom", "Left"],
        r = ["Attachment", "Color", "Image", "Repeat", "Position", "Size", "Clip", "Origin"];
    e.fn.bgswitcher = function() {
        var n = arguments,
            i = t.keys.instance;
        return this.each(function() {
            var o = e.data(this, i);
            o || (o = new t(this), e.data(this, i, o)), o.dispatch.apply(o, n)
        })
    }, e.fn.bgSwitcher = e.fn.bgswitcher, e.extend(t.prototype, {
        dispatch: function(e) {
            switch (o.call(e)) {
                case "[object Object]":
                    this.setConfig(e);
                    break;
                case "[object String]":
                    this[e].apply(this, i.call(arguments, 1));
                    break;
                default:
        ...
        setConfig: function(t) {
            this.config = e.extend(this.config, t), "undefined" != typeof this.config.random && (this.config.shuffle = this.config.random), this.refresh()
        },
        setImages: function(e) {
            this.imageList = new this.constructor.ImageList(e), this.config.shuffle && this.imageList.shuffle()
        },
        setSwitchHandler: function(t) {
            this.switchHandler = e.proxy(t, this)
        },
        getBuiltInSwitchHandler: function(e) {
            return this.constructor.switchHandlers[e || this.config.effect]
        },
        refresh: function() {
            this.setImages(this.config.images), this.setSwitchHandler(this.getBuiltInSwitchHandler()), this._prepareSwitching(), this.config.start && this.start()
        },
        start: function() {
            this._timerID || (this._timerID = setTimeout(e.proxy(this, "next"), this.config.interval))
        },
        stop: function() {
            this._timerID && (clearTimeout(this._timerID), this._timerID = null)
        },
        toggle: function() {
            this._timerID ? this.stop() : this.start()
        },
        reset: function() {
            this.index = 0, this._prepareSwitching()
        },
        next: function() {
            var e = this.imageList.count();
            (this.config.loop || this.index + 1 !== e) && (++this.index === e && (this.index = 0), this.switching())
        },
        prev: function() {
            (this.config.loop || 0 !== this.index) && (--this.index === -1 && (this.index = this.imageList.count() - 1), this.switching())
        },
        select: function(e) {
            e === -1 && (e = this.imageList.count() - 1), this.index = e, this.switching()
        },
        switching: function() {
            var e = !!this._timerID;
            e && this.stop(), this._createSwitchableElement(), this._prepareSwitching(), this.switchHandler(this.$switchable), e && this.start()
        },
        destroy: function() {
            this.stop(), this._stopListeningToResize(), this.$switchable && (this.$switchable.stop(), this.$switchable.remove(), this.$switchable = null), this.$bg && (this.$bg.remove(), this.$bg = null), this.$el.removeAttr("style"), this.$el.removeData(this.constructor.keys.instance), this.$el = null
        },
        _adjustRectangle: function() {
            for (var e, t = 0, n = s.length, i = this.$el.position(), o = {
                    top: i.top,
                    left: i.left,
                    width: this.$el.innerWidth(),
                    height: this.$el.innerHeight()
                }; t < n; t++) e = s[t], o["margin" + e] = this.$el.css("margin" + e), o["border" + e] = this.$el.css("border" + e);
            this.$bg.css(o)
        },
        _setupBackgroundElement: function() {
            this.$bg = e(document.createElement("div")), this.$bg.css({
                position: "absolute",
                zIndex: (parseInt(this.$el.css("zIndex"), 10) || 0) - 1,
                overflow: "hidden"
            }), this._copyBackgroundStyles(), this._adjustRectangle(), "BODY" === this.$el[0].tagName ? this.$el.prepend(this.$bg) : (this.$el.before(this.$bg), this.$el.css("background", "none"))
        },
        _createSwitchableElement: function() {
            this.$switchable && this.$switchable.remove(), this.$switchable = this.$bg.clone(), this.$switchable.css({
                top: 0,
                left: 0,
                margin: 0,
                border: "none"
        ...
        _copyBackgroundStyles: function() {
            for (var e, t = {}, n = 0, i = r.length, o = "backgroundPosition"; n < i; n++) e = "background" + r[n], t[e] = this.$el.css(e);
            void 0 === t[o] && (t[o] = [this.$el.css(o + "X"), this.$el.css(o + "Y")].join(" ")), this.$bg.css(t)
        },
        _listenToResize: function() {
            var t = this;
            this._resizeHandler = function() {
                t._adjustRectangle()
            }, e(window).on("resize", this._resizeHandler)
        },
        _stopListeningToResize: function() {
            e(window).off("resize", this._resizeHandler), this._resizeHandler = null
        },
    ...
    }, t.defineEffect = function(e, t) {
        this.switchHandlers[e] = t
    }, t.ImageList = function(e) {
        this.images = e, this.createImagesBySequence(), this.preload()
    }, e.extend(t.ImageList.prototype, {
        isSequenceable: function() {
            return "string" == typeof this.images[0] && "number" == typeof this.images[1] && "number" == typeof this.images[2]
        },
        createImagesBySequence: function() {
            if (this.isSequenceable()) {
                var e = [],
                    ...
                    n = this.images[1],
                    i = this.images[2];
                do e.push(t.replace(/\.\w+$/, n + "$&")); while (++n <= i);
                this.images = e
            }
        },
        preload: function() {
            for (var e, t = this.images.length, i = 0; i < t; i++) e = this.images[i], n[e] || (n[e] = new Image, n[e].src = e)
        },
        shuffle: function() {
            var e, t, n = this.images.length,
                i = this.images.join();
            if (n) {
                for (; n;) e = Math.floor(Math.random() * n), t = this.images[--n], this.images[n] = this.images[e], this.images[e] = t;
                this.images.join() === i && this.shuffle()
            }
        },
        get: function(e) {
